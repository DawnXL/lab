...
const ARCHETYPES = {
  '信仰狂热型': {
    title: '城堡原教旨主义',
    desc: '更偏向稳定且固定关系的理解方式。会更习惯一对一的绑定的结构；当关系出现偏离预期的组合时，容易产生明显的不适或排斥感，但内核通常仍是强烈的情感投入与信念感。'
  },
  '混乱快乐型': {
    title: '杂食狂欢派',
    desc: '对关系组合的变化接受度较高，能够理解并享受不同的CP排列方式与关系流动性。享受排列组合的快乐，时常会自己做饭，甚至端出一桌满汉全席。这类人是同人圈的气氛组+生产力核心。'
  },
  '佛系体验型': {
    title: '随缘吃饭',
    desc: '"你们吵你们的，我只是来吃饭的"，对CP的投入程度较为随性，遇到喜欢的内容会有好感，但不会强烈执着于特定关系走向或结构变化，更倾向于轻松观看与被动接收信息。'
  },
  '低调洁癖型': {
    title: '隐士守序党',
    desc: '更偏向稳定且明确的关系偏好，但表达较为克制，不一定积极参与讨论或扩展解读。通常会默默维持自己认可的关系理解方式，对过度偏离核心认知的变化接受度较低，但整体情绪表达较内敛。'
  }
};
